...
__all__ = [
    'SpeechBookmarkOptions', 'DISPID_SASFreeBufferSpace',
    'ISpXMLRecoResult', '_RemotableHandle',
    'SpeechSpecialTransitionType', 'SpeechCategoryVoices', 'SVP_19',
    'DISPID_SpeechRecoContext', 'DISPID_SVEVoiceChange',
    'DISPID_SGRId', 'SpeechPropertyResponseSpeed',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SpeechPhraseRules', 'SPAS_PAUSE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRRGetXMLErrorInfo', 'SpeechCategoryRecoProfiles',
    'DISPID_SpeechDataKey', 'SVSFParseAutodetect', 'LONG_PTR',
    'SPSVerb', 'SVP_14', 'SRERecognition', 'SP_VISEME_6',
    'DISPID_SRCreateRecoContext', 'SAFTGSM610_8kHzMono',
    'DISPID_SLGetGenerationChange', 'SPSEMANTICERRORINFO', 'SVP_5',
    'ISpeechPhraseAlternate', 'DISPID_SPRuleChildren',
    'DISPID_SpeechLexiconProns', 'DISPID_SWFEBitsPerSample',
    'ISpMMSysAudio', 'IEnumString', 'SPSHORTCUTTYPE',
    'SVEEndInputStream', 'DISPID_SPRuleParent', 'SPEI_VISEME',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPPS_RESERVED2',
    'DISPID_SRRSpeakAudio', 'DISPID_SpeechVoice', 'ISpeechPhraseInfo',
    'SP_VISEME_14', 'SPCS_ENABLED', 'SAFT16kHz16BitStereo',
    'eLEXTYPE_PRIVATE18', 'DISPID_SLGetPronunciations',
    'SpeechAudioVolume', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRGRules', 'DISPID_SRGCommit', 'ISpStreamFormat',
    'DISPID_SMSAMMHandle', 'Library', 'ISpeechDataKey',
    'ISpeechFileStream', 'ISpProperties', 'DISPID_SLWLangId',
    'DISPID_SPPValue', 'SpMMAudioOut', 'SpeechAudioState',
    'DISPID_SPIStartTime', 'SPINTERFERENCE_NONE', 'SPVPRI_NORMAL',
    'SPEI_START_SR_STREAM', 'DISPID_SVSInputSentencePosition',
    'SPWF_SRENGINE', 'SGRSTTEpsilon', 'SITooFast',
    'SAFT24kHz16BitStereo', 'SpPhraseInfoBuilder', 'SpMemoryStream',
    'SPPS_NotOverriden', 'ISpeechRecoResult2', 'tagSTATSTG',
    'SpeechRecognizerState', 'DISPID_SpeechGrammarRules',
    'DISPID_SOTDisplayUI', 'DISPID_SABIMinNotification',
    'SPSNotOverriden', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpeechRecoEvents', 'DISPID_SpeechLexicon', 'SPAR_Unknown',
    'SpInProcRecoContext', 'DISPIDSPTSI_SelectionLength',
    'SpeechPropertyComplexResponseSpeed', 'SAFT11kHz16BitStereo',
    'DISPID_SRCRecognizer', 'SPEI_PHRASE_START', 'SPPS_Unknown',
    'ISpStreamFormatConverter', 'SRTAutopause', 'SPEI_RESERVED2',
    'DISPID_SVSVisemeId', 'SREBookmark', 'SpeechStreamFileMode',
    'eLEXTYPE_PRIVATE5', 'SRSActiveAlways', 'SPEI_TTS_AUDIO_LEVEL',
    'SPRST_INACTIVE_WITH_PURGE', 'SPAS_CLOSED', 'SDKLCurrentUser',
    'DISPID_SWFEFormatTag', 'SRATopLevel', 'SDTAudio',
    'SPPHRASEREPLACEMENT', 'SpStream', 'DISPID_SDKOpenKey',
    'DISPID_SGRSTPropertyValue', 'SpPhoneConverter',
    'SPRST_NUM_STATES', 'SP_VISEME_7', 'DISPID_SVEEnginePrivate',
    'DISPID_SWFEChannels', 'SRARoot', 'SpeechUserTraining',
    'ISpShortcut', 'SpeechMicTraining', 'DISPID_SRCEStartStream',
    'SPPHRASERULE', 'DISPID_SPRsCount', 'IStream', 'STCAll',
    'DISPID_SPPEngineConfidence', 'IInternetSecurityManager',
    'DISPID_SPPName', 'DISPID_SPIGrammarId', 'SPINTERFERENCE',
    'SREPropertyStringChange', 'ISpeechAudioStatus', 'SVSFPersistXML',
    'STCInprocServer', 'SPEI_RESERVED5', 'DISPID_SRGState',
    'DISPID_SGRSTText', 'SpeechTokenKeyUI', 'DISPID_SVPause',
    'SVF_None', 'SPPS_Interjection', 'SVPAlert', 'DISPID_SPRuleId',
    'DISPID_SPAStartElementInResult', 'SFTSREngine',
    'eLEXTYPE_PRIVATE7', 'eLEXTYPE_PRIVATE17',
    'DISPID_SGRSTransitions', 'DISPID_SDKDeleteValue',
    'DISPID_SLPPhoneIds', 'DISPID_SPRuleFirstElement', 'SVP_4',
    'SpNotifyTranslator', 'SPPS_RESERVED3', 'SRAONone',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRSClsidEngine',
    'SECLowConfidence', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SPRs_NewEnum', 'SRSEDone',
    'DISPID_SRGCmdLoadFromResource', 'ISpeechLexiconPronunciations',
    'DISPID_SpeechFileStream', 'DISPID_SPIProperties',
    'SPPS_Modifier', 'SRTEmulated', 'DISPID_SRRTStreamTime',
    'DISPID_SVSInputSentenceLength', 'WAVEFORMATEX',
    'DISPID_SVEAudioLevel', 'DISPID_SPAPhraseInfo', 'SPSInterjection',
    'ISpRecoGrammar', 'SpStreamFormatConverter', 'SPFM_CREATE',
    'SpeechGrammarWordType', 'ISpeechGrammarRuleState',
    'DISPID_SRGetFormat', 'SAFTNoAssignedFormat',
    'SAFT32kHz8BitStereo', 'SREHypothesis', 'SVSFIsNotXML',
    'SSFMOpenForRead', 'SP_VISEME_12', 'DISPID_SOTCDefault',
    'DISPID_SRCRequestedUIType', 'SREPhraseStart', 'SRTSMLTimeout',
    'SRSInactiveWithPurge', 'SPAR_High', 'SVP_10', 'DISPID_SBSRead',
    'SECFIgnoreWidth', 'SPRST_ACTIVE', 'SpeechTokenKeyAttributes',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPFM_OPEN_READWRITE',
    'DISPID_SPEs_NewEnum', 'DISPID_SABIBufferSize', 'SPBO_AHEAD',
    'ISpeechPhraseAlternates', 'SRAExport',
    'DISPID_SPEEngineConfidence', 'DISPID_SDKCreateKey',
    'SPCONTEXTSTATE', 'SDA_Two_Trailing_Spaces', 'SPAS_STOP',
    'DISPID_SLWs_NewEnum', 'SpNullPhoneConverter', 'SP_VISEME_2',
    'DISPID_SABIEventBias', 'SpeechAudioFormatGUIDWave',
    'SPEI_TTS_BOOKMARK', 'DISPID_SPIReplacements', 'SpeechRuleState',
    'DISPID_SOTRemoveStorageFileName', 'SREPrivate',
    'Speech_Max_Word_Length', 'DISPIDSPTSI_SelectionOffset',
    'SAFTText', 'Speech_Max_Pron_Length', 'SSFMCreate',
    'DISPID_SRCEHypothesis', 'DISPID_SRCERecognitionForOtherContext',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SASCurrentSeekPosition',
    'ISpNotifySource', 'SDTDisplayText', 'SAFTGSM610_22kHzMono',
    'DISPID_SOTGetDescription', 'DISPID_SRGCmdSetRuleState',
    'SAFTADPCM_8kHzMono', 'SAFT16kHz16BitMono', 'SRERecoOtherContext',
    'SWTAdded', 'DISPID_SGRAddResource', 'SPSLMA',
    'DISPID_SpeechAudio', 'SPWT_PRONUNCIATION', 'ISpDataKey',
    'SpeechLexiconType', 'SAFTGSM610_11kHzMono', 'SpFileStream',
    'DISPID_SOTSetId', 'SPSHT_Unknown', 'DISPID_SRGetRecognizers',
    'SPRECOCONTEXTSTATUS', 'SAFTExtendedAudioFormat',
    'DISPID_SRGRecoContext', 'DISPID_SPPNumberOfElements', 'SVP_20',
    'SPPS_Verb', 'SpeechTokenValueCLSID', 'DISPID_SRCEAdaptation',
    'SPPHRASEPROPERTY', 'SpMMAudioIn', 'DISPID_SVSLastResult',
    'DISPID_SOTCId', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SpeechWaveFormatEx', 'SPAR_Low', 'SVP_1',
    'DISPID_SRState', 'DISPID_SRCEAudioLevel',
    'SpObjectTokenCategory', 'SPAR_Medium', 'DISPID_SLGenerationId',
    'DISPID_SWFESamplesPerSec', 'DISPID_SBSSeek', 'SRESoundEnd',
    'ISpeechRecoGrammar', 'SPSMF_SAPI_PROPERTIES', 'SP_VISEME_17',
    'DISPID_SpeechPhoneConverter', 'ISpPhrase', 'SINoise',
    'SREFalseRecognition', 'SpeechVisemeType', 'SASRun',
    'DISPID_SAVolume', 'DISPID_SDKEnumKeys', 'SPSHORTCUTPAIR',
    'SFTInput', 'ISpPhraseAlt', 'SpeechCategoryAudioIn',
    'ISpeechPhraseElement', 'SRTReSent', 'DISPID_SDKGetStringValue',
    'SpShortcut', 'SpeechVoiceSpeakFlags', 'SPEI_END_SR_STREAM',
    'SDTAlternates', 'SpeechStreamSeekPositionType', 'SSTTWildcard',
    'DISPID_SVStatus', 'SPGS_EXCLUSIVE', 'SPWF_INPUT',
    'ISpeechObjectToken', 'STSF_CommonAppData',
    'SPEI_START_INPUT_STREAM', 'SVEAllEvents',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SAFGetWaveFormatEx',
    'SAFT22kHz8BitStereo', 'DISPID_SRRSaveToMemory',
    'DISPID_SpeechMemoryStream', 'eLEXTYPE_RESERVED10',
    'DISPID_SRCERequestUI', 'ISpEventSink', 'DISPID_SLWsItem',
    'SPRS_ACTIVE', 'ISequentialStream', 'DISPID_SPIElements',
    'SVSFIsFilename', 'SPSEMANTICFORMAT', 'SVEWordBoundary',
    'SPPS_RESERVED1', 'DISPID_SVSpeakStream',
    'DISPID_SVSRunningState', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'DISPID_SOTId',
    'SPEI_SR_RETAINEDAUDIO', 'SAFTCCITT_uLaw_8kHzMono',
    'SPEI_REQUEST_UI', 'SPCT_COMMAND', 'DISPID_SWFEBlockAlign',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRCESoundEnd',
    'DISPID_SVEStreamEnd', 'DISPID_SRCRetainedAudioFormat',
    'eLEXTYPE_PRIVATE20', 'SP_VISEME_20', 'DISPID_SPEAudioSizeTime',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SRAudioInputStream',
    'SpeechVoiceEvents', 'eLEXTYPE_USER', 'DISPID_SLWsCount',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SVDisplayUI',
    'SpeechCategoryAudioOut', 'eLEXTYPE_PRIVATE15', 'SVP_17',
    'SPINTERFERENCE_NOISE', 'SVPOver',
    'DISPID_SVSLastStreamNumberQueued', 'SP_VISEME_9',
    'DISPID_SPRuleEngineConfidence',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechAddRemoveWord',
    'ISpeechTextSelectionInformation', 'SVP_16', 'SPEI_RESERVED3',
    'DISPID_SVSInputWordPosition', 'SVEPhoneme',
    'DISPID_SpeechPhraseProperties', 'SPPS_Function',
    'DISPID_SVAudioOutputStream', 'ISpeechAudioBufferInfo',
    'ISpRecoGrammar2', 'DISPID_SPILanguageId',
    'SAFTCCITT_ALaw_44kHzStereo', 'SAFTCCITT_uLaw_44kHzMono',
    'SAFT22kHz16BitStereo', 'ISpRecognizer',
    'SpeechVoiceSkipTypeSentence', 'ISpeechObjectTokenCategory',
    'DISPID_SRGetPropertyString', 'SREAllEvents',
    'DISPID_SPRules_NewEnum', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SpeechGrammarRuleState', 'ISpAudio', 'SPCT_SLEEP',
    'SPXMLRESULTOPTIONS', 'SRCS_Enabled', 'DISPID_SASetState',
    'DISPID_SRGIsPronounceable', 'SAFTADPCM_44kHzStereo',
    'SVSFUnusedFlags', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SRRPhraseInfo', 'DISPID_SLPSymbolic', 'SWTDeleted',
    'DISPID_SRGDictationSetState', 'SLTUser', 'SPVPRIORITY',
    'ISpPhoneticAlphabetSelection', 'SPEVENTSOURCEINFO',
    'IEnumSpObjectTokens', 'DISPID_SRRAudio', 'SPSHT_OTHER',
    'SpeechRegistryUserRoot', 'SPWORD', 'SpeechWordType',
    'SGRSTTDictation', 'DISPID_SpeechPhraseBuilder', 'SP_VISEME_11',
    'SpeechTokenContext', 'SPWT_DISPLAY', 'SPPROPERTYINFO',
    'DISPID_SLPPartOfSpeech', 'SASClosed', 'DISPID_SRRTLength',
    'DISPID_SRGDictationLoad', 'DISPID_SPPId',
    'DISPID_SRGCmdLoadFromMemory', 'SPSMF_UPS', 'SPRULE',
    'DISPID_SPIEngineId', 'tagSPPROPERTYINFO', 'SGSEnabled',
    'SPSTREAMFORMATTYPE', 'DISPID_SRCEEnginePrivate',
    'SWPUnknownWordPronounceable', 'SPPS_Noun', 'ISpRecognizer2',
    'SDKLCurrentConfig', 'SpeechRecoProfileProperties',
    'ISpPhoneticAlphabetConverter', 'DISPIDSPTSI',
    'DISPID_SVEStreamStart', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRRecognizer', 'DISPID_SRIsUISupported', 'SBONone',
    'SpeechDataKeyLocation', 'SPEI_PHONEME',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpeechGrammarRules', 'SP_VISEME_1',
    'DISPID_SRGetPropertyNumber', 'SPPS_Noncontent',
    'ISpObjectWithToken', 'DISPID_SMSSetData', 'DISPID_SPRulesCount',
    'SPFM_OPEN_READONLY', 'SPEI_MAX_SR', 'ISpeechPhraseProperties',
    'SPEI_HYPOTHESIS', 'DISPID_SPRNumberOfElements',
    'ISpeechRecoContext', 'DISPID_SLPLangId', 'DISPID_SMSGetData',
    'DISPID_SVPriority', 'eLEXTYPE_PRIVATE11', 'ISpRecoContext2',
    'DISPID_SOTDataKey', 'SVSFNLPSpeakPunc', 'SPAO_NONE',
    'DISPID_SGRSTType', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SPRuleName', 'SPWORDLIST', 'DISPID_SMSALineId',
    'SpeechCategoryAppLexicons', 'SECNormalConfidence',
    'DISPID_SpeechPhraseAlternates', 'SAFT44kHz16BitMono',
    'SPRST_INACTIVE', 'SPCS_DISABLED',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpeechGrammarRule',
    'SpPhoneticAlphabetConverter', 'DISPID_SpeechPhraseInfo',
    'DISPID_SpeechPhraseElements', 'DISPID_SOTCGetDataKey',
    'eLEXTYPE_PRIVATE2', 'SRESoundStart', 'DISPID_SPAs_NewEnum',
    'DISPID_SpeechLexiconWord', 'SAFT22kHz16BitMono',
    'ISpeechLexiconPronunciation', 'SGDSActiveWithAutoPause',
    'SPEI_WORD_BOUNDARY', 'SPPHRASEELEMENT', 'SPPS_LMA',
    'DISPID_SOTsItem', 'SECFDefault', 'SPLO_STATIC', 'SRSActive',
    'ISpeechVoice', 'SPEI_SR_PRIVATE', 'DISPID_SGRAddState', 'SVP_0',
    'eLEXTYPE_PRIVATE9', 'SAFT8kHz16BitStereo', 'SPSSuppressWord',
    'SPBO_NONE', 'SVP_7', 'DISPID_SGRSTRule', 'DISPID_SRProfile',
    'DISPID_SpeechPhraseElement', 'DISPID_SpeechPhraseRule',
    'SAFT8kHz8BitStereo', 'SDA_One_Trailing_Space',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SRADynamic',
    'DISPID_SRIsShared', 'DISPID_SLRemovePronunciation',
    'SECFEmulateResult', 'SpeechDictationTopicSpelling',
    'SpeechEngineProperties', 'SVEViseme',
    'ISpeechPhraseReplacements', 'SPCT_SUB_COMMAND',
    'SpeechAllElements', 'SPEVENTENUM', 'STCInprocHandler',
    'SSSPTRelativeToEnd', 'DISPID_SGRSAddRuleTransition',
    'SpSharedRecognizer', 'eLEXTYPE_PRIVATE3',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SRADefaultToActive',
    'SVSFVoiceMask', 'DISPID_SVEPhoneme', 'eWORDTYPE_DELETED',
    'Speech_StreamPos_RealTime', 'ISpeechObjectTokens',
    'ISpeechLexiconWord', 'SVP_8', 'SPSUnknown',
    'DISPID_SRCESoundStart', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SPCLangId', 'SRSEIsSpeaking', 'SECFIgnoreCase',
    'SPAUDIOSTATE', 'SpeechPropertyAdaptationOn',
    'DISPID_SRCCmdMaxAlternates', 'SDA_No_Trailing_Space',
    'DISPID_SRRTTickCount', 'SPAUDIOBUFFERINFO', 'SPRS_INACTIVE',
    'SPAO_RETAIN_AUDIO', 'DISPID_SVSkip', 'SPWORDTYPE',
    'DISPID_SOTCategory', 'SVP_15', 'SAFTADPCM_11kHzStereo',
    'SP_VISEME_16', 'SPWT_LEXICAL', 'SVP_3', 'SPCATEGORYTYPE',
    'SPVPRI_OVER', 'SPEI_TTS_PRIVATE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SASStop',
    'eLEXTYPE_APP', 'DISPID_SpeechAudioStatus', 'SREStreamEnd',
    'DISPID_SpeechVoiceEvent', 'DISPID_SCSBaseStream',
    'SPEI_UNDEFINED', 'SWPKnownWordPronounceable', 'SINoSignal',
    'SGRSTTRule', '_ISpeechVoiceEvents', 'ISpeechPhraseRules',
    'SpeechDisplayAttributes', 'SPXRO_Alternates_SML',
    'DISPID_SRRGetXMLResult', 'SVSFParseSsml',
    'DISPID_SPELexicalForm', 'SPEI_INTERFERENCE', 'SITooQuiet',
    'SPWORDPRONOUNCEABLE', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRRAudioFormat', 'SP_VISEME_3', 'SpeechEngineConfidence',
    'ISpeechVoiceStatus', 'typelib_path', 'DISPID_SLGetWords',
    'SPSNoun', 'DISPID_SRRDiscardResultInfo', 'DISPID_SOTCSetId',
    'DISPID_SOTGetStorageFileName', 'DISPID_SPEPronunciation',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SVESentenceBoundary',
    'DISPID_SWFEExtraData', 'SPEI_ADAPTATION', 'SRAInterpreter',
    'DISPID_SMSADeviceId', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SPIAudioSizeTime', 'eLEXTYPE_PRIVATE1', 'SRAORetainAudio',
    'SGRSTTWord', 'DISPIDSPRG', 'SPCT_SUB_DICTATION',
    'SWPUnknownWordUnpronounceable', 'SpeechFormatType',
    'SpObjectToken', 'SPEI_SOUND_END', 'Speech_Default_Weight',
    'DISPID_SPERetainedSizeBytes', 'ISpeechWaveFormatEx',
    'SGSDisabled', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechRecognizerStatus', 'SPRECOGNIZERSTATUS',
    'DISPID_SOTGetAttribute', 'DISPID_SPPFirstElement',
    'DISPID_SRRTimes', 'DISPID_SRCEEndStream',
    'DISPID_SPANumberOfElementsInResult', 'SpVoice',
    'DISPID_SPRuleNumberOfElements', 'ISpeechXMLRecoResult',
    'SPWAVEFORMATTYPE', 'eLEXTYPE_PRIVATE10', 'SAFT11kHz8BitMono',
    'SVP_9', 'DISPID_SRGCmdSetRuleIdState', 'SAFTADPCM_44kHzMono',
    'SPEI_MIN_TTS', 'SVSFParseSapi', 'DISPID_SGRSTPropertyId',
    'SpeechPropertyLowConfidenceThreshold', 'SP_VISEME_19',
    'SAFT44kHz8BitStereo', 'DISPID_SPIEnginePrivateData',
    'SPPS_SuppressWord', 'DISPID_SpeechMMSysAudio',
    'DISPID_SVGetAudioOutputs', 'DISPID_SDKGetBinaryValue', 'SVP_21',
    'DISPID_SGRsItem', 'SPEI_RECOGNITION', 'SAFT32kHz16BitStereo',
    'DISPID_SLWType', 'DISPID_SVGetVoices', 'SPSHT_EMAIL',
    'SPRECOSTATE', 'DISPID_SOTCEnumerateTokens', 'SPBINARYGRAMMAR',
    'SP_VISEME_18', 'ISpeechGrammarRuleStateTransition',
    'STSF_FlagCreate', 'SPGS_DISABLED', 'SpeechVoicePriority',
    'DISPID_SPRDisplayAttributes', 'DISPID_SVResume',
    'DISPID_SRGCmdLoadFromFile', 'eLEXTYPE_RESERVED4',
    'DISPID_SPIGetText', 'DISPID_SOTCreateInstance',
    'DISPID_SVGetProfiles', 'SVEAudioLevel', 'DISPID_SRCResume',
    'SRCS_Disabled', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SPAsItem', 'SPXRO_SML', 'SPVOICESTATUS',
    'SAFTCCITT_ALaw_22kHzStereo',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SDTProperty',
    'DISPID_SRSSupportedLanguages', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SpeechLexiconWords', 'DISPID_SPEDisplayText',
    'DISPID_SPERequiredConfidence', 'DISPID_SRRAlternates',
    'DISPID_SVEBookmark', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPPARTOFSPEECH', 'SP_VISEME_5', 'ISpPhoneConverter',
    'SpCustomStream', 'DISPID_SpeechObjectTokenCategory',
    'SECFNoSpecialChars', 'DISPID_SpeechPhraseReplacements',
    'SPEI_SOUND_START', 'DISPID_SGRsAdd', 'STCRemoteServer',
    'DISPID_SABufferNotifySize', 'SVEVoiceChange', 'SPVPRI_ALERT',
    'SPINTERFERENCE_NOSIGNAL', 'STCLocalServer', 'SVP_6',
    'SSTTTextBuffer', 'ISpRecoContext', 'SPPHRASE',
    'SPGRAMMARWORDTYPE', 'SpeechWordPronounceable', 'UINT_PTR',
    'SVP_18', 'SAFT32kHz16BitMono', 'SPSHT_NotOverriden', 'SITooLoud',
    'SPEI_RECO_STATE_CHANGE', 'eLEXTYPE_RESERVED6',
    'DISPID_SGRSAddSpecialTransition', 'SPSFunction',
    'DISPID_SRRRecoContext', 'SREPropertyNumChange', 'SVSFlagsAsync',
    'SAFT32kHz8BitMono', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SRCEventInterests', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SFSClose', 'SpeechRecoContextState', 'SpResourceManager',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SpeechRunState',
    'ISpeechCustomStream', 'DISPID_SRCVoicePurgeEvent',
    'SAFTGSM610_44kHzMono', 'DISPID_SPRulesItem',
    'SAFT12kHz16BitStereo', 'DISPID_SLWPronunciations', 'SPBO_PAUSE',
    'SAFT8kHz16BitMono', 'DISPID_SPEActualConfidence',
    'SAFTADPCM_8kHzStereo', 'DISPID_SVWaitUntilDone',
    'SAFTNonStandardFormat', 'DISPID_SVSInputWordLength',
    'DISPID_SRSetPropertyNumber', 'SPAS_RUN', 'DISPID_SGRSTNextState',
    'eLEXTYPE_PRIVATE14', 'eLEXTYPE_PRIVATE19',
    'SAFTADPCM_22kHzStereo', 'SDTPronunciation',
    'DISPID_SVSCurrentStreamNumber', 'ISpeechRecoResultDispatch',
    'SRTExtendableParse', 'SpMMAudioEnum', 'DISPID_SPCPhoneToId',
    'DISPID_SDKDeleteKey', 'SGPronounciation', 'SpInprocRecognizer',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SpeechGrammarRule',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SASState', 'SPLEXICONTYPE',
    'DISPID_SpeechRecoContextEvents', 'SPGRAMMARSTATE',
    'DISPID_SVEViseme', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SpTextSelectionInformation', 'ISpeechPhraseReplacement',
    'SBOPause', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SGRsFindRule', 'DISPID_SRCEInterference',
    'SDKLLocalMachine', 'SGDSActiveUserDelimited',
    'DISPID_SRCCreateGrammar', 'SPDKL_CurrentConfig', 'SVP_11',
    'SLOStatic', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SASPause',
    'SAFT11kHz8BitStereo', 'STSF_AppData', 'ISpLexicon',
    'DISPID_SGRsCommit', 'SpeechRuleAttributes',
    'DISPID_SREmulateRecognition', 'DISPID_SAFType',
    'DISPID_SRDisplayUI', 'SPSERIALIZEDRESULT', 'SAFT16kHz8BitMono',
    'ISpeechAudio', 'SECFIgnoreKanaType', 'DISPID_SAFGuid',
    'SVSFIsXML', 'DISPID_SADefaultFormat', 'ISpResourceManager',
    'DISPID_SAEventHandle', 'DISPID_SOTIsUISupported',
    'DISPID_SRCEFalseRecognition', 'SpLexicon', 'SDTLexicalForm',
    'DISPID_SASCurrentDevicePosition', 'SP_VISEME_13', 'SGDSInactive',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SOTsCount',
    'ISpeechPhraseElements', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SpeechGrammarRuleStateTransition', 'SAFT12kHz16BitMono',
    'DISPID_SBSWrite', 'DISPID_SVSLastBookmarkId', 'SPFM_NUM_MODES',
    'SVF_Emphasis', 'DISPID_SVEWord', 'DISPID_SVSLastBookmark',
    'SREInterference', 'DISPID_SVSPhonemeId', 'SP_VISEME_21',
    'SAFTADPCM_22kHzMono', 'SPBOOKMARKOPTIONS',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPARecoResult',
    'DISPID_SLAddPronunciation', 'SpeechRecognitionType',
    'SPWORDPRONUNCIATION', 'SPEI_END_INPUT_STREAM', 'DISPID_SVVoice',
    'SREStreamStart', 'SREStateChange', 'SSSPTRelativeToStart',
    'SpeechAudioFormatGUIDText', 'DISPID_SOTRemove',
    'DISPID_SGRClear', 'DISPID_SGRSAddWordTransition',
    'DISPID_SRCEBookmark', 'SVSFPurgeBeforeSpeak', 'SPAUDIOSTATUS',
    'DISPID_SPACommit', 'SVP_2',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SLWWord',
    'SpeechGrammarRuleStateTransitionType', 'ISpeechRecoResultTimes',
    'DISPID_SpeechAudioFormat', 'SPDKL_DefaultLocation',
    'DISPID_SGRsCommitAndSave', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SpeechPhraseProperty', 'SPSERIALIZEDPHRASE',
    'SDKLDefaultLocation', 'SAFT48kHz8BitStereo', 'SPGS_ENABLED',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SVAudioOutput', 'SVPNormal',
    'DISPID_SpeechObjectTokens', 'DISPID_SPRuleConfidence',
    'DISPID_SGRName', 'SDTReplacement', 'DISPID_SVSpeakCompleteEvent',
    'SPLO_DYNAMIC', 'SPEVENT', 'SPVISEMES', 'eWORDTYPE_ADDED',
    'ISpeechPhraseProperty', 'SAFT12kHz8BitStereo',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SLPType', 'DISPID_SPPsItem',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SPPsCount',
    'DISPID_SpeechRecoResult', 'SRSInactive', 'DISPID_SOTs_NewEnum',
    'SPEI_RESERVED6', 'SpCompressedLexicon', 'Speech_StreamPos_Asap',
    'DISPID_SPPChildren', 'ISpStream', 'DISPID_SPPConfidence',
    'SpeechAudioFormatType', 'SAFT48kHz16BitStereo',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRSetPropertyString',
    'SPCT_DICTATION', 'ISpeechGrammarRuleStateTransitions',
    'SP_VISEME_10', 'SAFT11kHz16BitMono', 'SpeechGrammarTagWildcard',
    'DISPID_SLPsItem', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SDKEnumValues', 'SAFTADPCM_11kHzMono',
    '_ISpeechRecoContextEvents', 'DISPID_SPIRetainedSizeBytes',
    'SSTTDictation', 'SAFT8kHz8BitMono', 'SVEPrivate',
    'SpeechVoiceCategoryTTSRate', 'ISpRecognizer3', 'SRTStandard',
    'ISpeechPhoneConverter', 'ISpeechLexicon',
    'DISPID_SpeechRecognizer', 'DISPID_SGRSTsItem',
    'eLEXTYPE_PRIVATE6', 'DISPID_SGRInitialState', 'SPBO_TIME_UNITS',
    'SPEI_SR_BOOKMARK', 'ISpEventSource', 'SECHighConfidence',
    'DISPID_SDKGetlongValue', 'DISPID_SRSNumberOfActiveRules',
    'SP_VISEME_8', 'DISPID_SPCIdToPhone',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPRULESTATE', 'SAFT24kHz8BitMono',
    'DISPID_SGRSTWeight', 'DISPID_SVRate', 'DISPID_SVAlertBoundary',
    'DISPID_SpeechRecoResult2', 'DISPID_SRAudioInput',
    'DISPID_SpeechObjectToken', 'SITooSlow', 'DISPID_SPRText',
    'SVSFNLPMask', 'eLEXTYPE_LETTERTOSOUND',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SGRAttributes',
    'DISPID_SDKSetLongValue', 'SPFM_CREATE_ALWAYS',
    'ISpNotifyTranslator', 'DISPID_SPRsItem', 'SAFT48kHz8BitMono',
    'DISPID_SRSCurrentStreamPosition', 'ISpNotifySink',
    'DISPID_SPIGetDisplayAttributes', 'SpSharedRecoContext',
    'SPEI_RESERVED1', 'SP_VISEME_4', 'DISPID_SRGSetTextSelection',
    'DISPID_SRCBookmark', 'DISPID_SpeechPhraseReplacement',
    'SpUnCompressedLexicon', 'DISPID_SWFEAvgBytesPerSec',
    'ISpeechMemoryStream', 'ISpeechRecognizerStatus', 'SINone',
    'SPRECORESULTTIMES', 'SpeechRetainedAudioOptions',
    'DISPID_SBSFormat', 'ISpeechResourceLoader', 'DISPID_SGRsCount',
    'SPTEXTSELECTIONINFO', 'SVSFParseMask',
    'DISPID_SPEDisplayAttributes', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SDKSetStringValue', 'SGLexical', 'SREAdaptation',
    'DISPID_SPAsCount', 'SAFT24kHz8BitStereo', 'DISPID_SRGReset',
    'tagSPTEXTSELECTIONINFO', 'ISpVoice', 'DISPID_SVIsUISupported',
    'DISPID_SPIRule', 'eLEXTYPE_PRIVATE4', 'ISpGrammarBuilder',
    'SPEI_VOICE_CHANGE', 'SLODynamic', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SPEsItem', 'SpeechCategoryRecognizers', 'SPEI_MIN_SR',
    'DISPID_SGRSRule', 'DISPID_SRCCreateResultFromMemory',
    'eLEXTYPE_PRIVATE13', 'SPAUDIOOPTIONS', 'eLEXTYPE_RESERVED9',
    'ISpeechLexiconWords', 'SPINTERFERENCE_TOOSLOW', 'SPSModifier',
    'DISPID_SpeechVoiceStatus', 'DISPID_SRGDictationUnload',
    'SGDSActive', 'SDA_Consume_Leading_Spaces', 'SpWaveFormatEx',
    'SAFTCCITT_ALaw_11kHzMono', 'SAFTCCITT_uLaw_11kHzStereo',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpeechPhraseRule',
    'DISPID_SRStatus', 'SPADAPTATIONRELEVANCE', 'SP_VISEME_0',
    'DISPID_SRSCurrentStreamNumber', 'SpeechPropertyResourceUsage',
    'DISPID_SPISaveToMemory', 'SpeechTokenKeyFiles',
    'IInternetSecurityMgrSite', 'DISPID_SGRsDynamic',
    'SPDKL_LocalMachine', 'DISPID_SRGCmdLoadFromObject', 'SDTAll',
    'DISPID_SRCEPhraseStart', 'SSFMCreateForWrite', 'DISPID_SRCVoice',
    'SpAudioFormat', 'eLEXTYPE_PRIVATE16', 'ISpeechAudioFormat',
    'SpeechTokenShellFolder', 'SSFMOpenReadWrite',
    'DISPID_SRCERecognition', 'SVP_13', 'DISPID_SpeechCustomStream',
    'DISPID_SGRs_NewEnum', 'SRERequestUI', 'SAFT12kHz8BitMono',
    'SAFT44kHz16BitStereo', 'SpeechGrammarTagDictation',
    'eLEXTYPE_RESERVED8', 'ISpSerializeState',
    'DISPID_SPEAudioStreamOffset', 'SVESentenceBoundary',
    'SAFTCCITT_ALaw_8kHzMono', 'eLEXTYPE_RESERVED7', 'SLTApp',
    'DISPID_SRGSetWordSequenceData', 'SREAudioLevel', 'SRAImport',
    'SPEI_MAX_TTS', 'SPSHORTCUTPAIRLIST', 'DISPID_SVEventInterests',
    'SGLexicalNoSpecialChars', 'ISpRecoResult', 'SAFT44kHz8BitMono',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SVVolume',
    'DISPID_SABufferInfo', 'DISPID_SFSOpen',
    'DISPID_SVSyncronousSpeakTimeout', 'eLEXTYPE_PRIVATE12',
    'SVEBookmark', 'SpeechCategoryPhoneConverters',
    'DISPID_SRCEPropertyStringChange', 'SP_VISEME_15', 'DISPID_SRGId',
    'STSF_LocalAppData', 'DISPID_SRCState', 'SPINTERFERENCE_TOOLOUD',
    'ISpeechMMSysAudio', 'ISpObjectToken', 'SpeechLoadOption',
    'SAFTDefault', 'DISPID_SGRSTPropertyName',
    'DISPID_SRCRetainedAudio', 'SDTRule', 'SVSFDefault',
    'SpeechAudioProperties', 'SGSExclusive', 'DISPID_SPPs_NewEnum',
    'SVP_12', 'SPINTERFERENCE_TOOFAST', 'ISpeechRecognizer',
    'SpeechEmulationCompareFlags', 'SPPS_RESERVED4',
    'SpeechGrammarState', 'SpeechVisemeFeature', 'SGRSTTTextBuffer',
    'SGDisplay', 'SAFT48kHz16BitMono', 'SAFT16kHz8BitStereo',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SRSAudioStatus',
    'SPFILEMODE', 'DISPID_SRCSetAdaptationData',
    'SPEI_PROPERTY_STRING_CHANGE', '_SPAUDIOSTATE', 'ISpRecoCategory',
    'DISPID_SpeechBaseStream', 'SPDKL_CurrentUser', 'DISPID_SVSpeak',
    'DISPID_SRCPause', 'SAFT24kHz16BitMono', 'ISpObjectTokenCategory',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SVGetAudioInputs',
    'DISPID_SLPs_NewEnum', 'SpeechTokenIdUserLexicon',
    'DISPID_SDKSetBinaryValue', 'DISPID_SASNonBlockingIO',
    'DISPID_SAStatus', 'DISPID_SGRSTsCount', 'SpeechInterference',
    'SpeechPartOfSpeech', 'SVEStartInputStream',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SLPsCount',
    'ISpeechPhraseInfoBuilder', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SOTMatchesAttributes', 'ISpeechRecoResult',
    'DISPID_SPEsCount', 'SPDATAKEYLOCATION', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPRFirstElement', 'SAFT22kHz8BitMono',
    'DISPID_SRRTOffsetFromStart', 'SpeechDiscardType',
    'DISPID_SPPParent', '__MIDL_IWinTypes_0009', 'ISpeechBaseStream',
    'eLEXTYPE_PRIVATE8', 'SGRSTTWildcard', 'SPLOADOPTIONS',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SVF_Stressed'
]

_check_version('1.4.0', 1700057322.105059)
